...
- Everything runs on free tiers — Supabase and Vercel — with no per-use cost. Manual recipe saving is planned for later but isn't built yet; for now, log meals directly.
