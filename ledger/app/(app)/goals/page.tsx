  ...
  return (
    <>
      ...
      <div className="goal-note">
        Everything you log here — meals, water, birth control, period, GLP-1, sex — is stored in your own Supabase database, protected by row-level security so only your signed-in account can read it. Nothing here is sent to any third party.
      </div>
    </>
  );
}
